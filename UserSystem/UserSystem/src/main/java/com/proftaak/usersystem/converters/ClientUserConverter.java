...
public class ClientUserConverter
{
	public ClientUser toEntity(com.proftaak.usersystem.shared.ClientUser user) {
		return new ClientUser(user.getId(), user.getName(), user.getAddress(), user.getResidence(), user.getOwnedCarIds(), user.getEmail());
	}

	public com.proftaak.usersystem.shared.ClientUser toShared(ClientUser user) {
		return new com.proftaak.usersystem.shared.ClientUser(user.getId(), user.getName(), user.getAddress(), user.getResidence(), user.getOwnedCarIds(), user.getEmail());
	}
}
