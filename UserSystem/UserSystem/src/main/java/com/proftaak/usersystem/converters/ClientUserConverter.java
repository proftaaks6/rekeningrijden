...
public class ClientUserConverter
{
	...
	public com.proftaak.usersystem.shared.ClientUser toShared(ClientUser user) {
		return new com.proftaak.usersystem.shared.ClientUser(user.getId(), user.getName(), user.getAddress(), user.getResidence(), user.getOwnedVehicleChassisNumbers(), user.getEmail());
	}
